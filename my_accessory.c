...
homekit_characteristic_t cha_name = HOMEKIT_CHARACTERISTIC_(NAME, "ESP8266 Development board");
...
homekit_characteristic_t cha_name1 = HOMEKIT_CHARACTERISTIC_(NAME, "Temperature Sensor - dummy");
